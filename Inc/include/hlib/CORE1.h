...
#define HAllocOutpCtrl(ph,par,type,length,elem)           \
  HPAllocOutpCtrl( ph, par, type, length, (void*) elem)
...
HPGetPElem( Hproc_handle ph, INT par, 
            void const*restrict*elem, INT4_8 *num, INT *type) ;
