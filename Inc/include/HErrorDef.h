...
#define H_ERR_REMOTE_DESKTOP 5184 /* Operator not available with Windows
                                     Remote Desktop */
...
#define H_ERR_OCR_KNN_NOCLASSFILE 8333 /* Invalid file format for 
                                          k-NN classifier */
#define H_ERR_OCR_KNN_NOSITEM     8332 /* Serialized item does not contain
