...
LIntExport Herror T_transform_metrology_object(const Htuple MetrologyHandle, const Htuple Indices, const Htuple Row, const Htuple Column, const Htuple Phi, const Htuple Mode);
LIntExport Herror transform_metrology_object(Hlong MetrologyHandle, const char *Indices, double Row, double Column, double Phi, const char *Mode);
...
LIntExport Herror T_copy_metrology_model(const Htuple MetrologyHandle, const Htuple Indices, Htuple *CopiedMetrologyHandle);
LIntExport Herror copy_metrology_model(Hlong MetrologyHandle, const char *Indices, Hlong *CopiedMetrologyHandle);
LIntExport Herror T_copy_metrology_object(const Htuple MetrologyHandle, const Htuple Indices, Htuple *CopiedIndices);
LIntExport Herror copy_metrology_object(Hlong MetrologyHandle, const char *Indices, Hlong *CopiedIndices);
LIntExport Herror T_get_metrology_object_num_instances(const Htuple MetrologyHandle, const Htuple Indices, Htuple *NumInstances);
LIntExport Herror get_metrology_object_num_instances(Hlong MetrologyHandle, Hlong Indices, double *NumInstances);
LIntExport Herror T_get_metrology_object_result(const Htuple MetrologyHandle, const Htuple Indices, const Htuple Instance, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Parameter);
LIntExport Herror get_metrology_object_result(Hlong MetrologyHandle, Hlong Indices, Hlong Instance, const char *GenParamName, const char *GenParamValue, double *Parameter);
LIntExport Herror T_get_metrology_object_measures(Hobject *Contour, const Htuple MetrologyHandle, const Htuple Indices, const Htuple Transition, Htuple *Row, Htuple *Column);
...
LIntExport Herror T_reset_metrology_object_fuzzy_param(const Htuple MetrologyHandle, const Htuple Indices);
LIntExport Herror reset_metrology_object_fuzzy_param(Hlong MetrologyHandle, const char *Indices);
LIntExport Herror T_reset_metrology_object_param(const Htuple MetrologyHandle, const Htuple Indices);
LIntExport Herror reset_metrology_object_param(Hlong MetrologyHandle, const char *Indices);
LIntExport Herror T_get_metrology_object_fuzzy_param(const Htuple MetrologyHandle, const Htuple Indices, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_metrology_object_fuzzy_param(Hlong MetrologyHandle, const char *Indices, const char *GenParamName, double *GenParamValue);
LIntExport Herror T_get_metrology_object_param(const Htuple MetrologyHandle, const Htuple Indices, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_metrology_object_param(Hlong MetrologyHandle, const char *Indices, const char *GenParamName, char *GenParamValue);
LIntExport Herror T_set_metrology_object_fuzzy_param(const Htuple MetrologyHandle, const Htuple Indices, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_metrology_object_fuzzy_param(Hlong MetrologyHandle, const char *Indices, const char *GenParamName, double GenParamValue);
LIntExport Herror T_set_metrology_object_param(const Htuple MetrologyHandle, const Htuple Indices, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_metrology_object_param(Hlong MetrologyHandle, const char *Indices, const char *GenParamName, const char *GenParamValue);
...
LIntExport Herror T_clear_metrology_object(const Htuple MetrologyHandle, const Htuple Indices);
LIntExport Herror clear_metrology_object(Hlong MetrologyHandle, const char *Indices);
...
LIntExport Herror T_set_object_model_3d_attrib_mod(const Htuple ObjectModel3D, const Htuple Name, const Htuple Type, const Htuple Data);
LIntExport Herror set_object_model_3d_attrib_mod(Hlong ObjectModel3D, const char *Name, const char *Type, double Data);
LIntExport Herror T_set_object_model_3d_attrib(const Htuple ObjectModel3D, const Htuple Name, const Htuple Type, const Htuple Data, Htuple *ObjectModel3DOut);
