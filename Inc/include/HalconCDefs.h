...
#define     HALCON_C_VERS             "11.0"
#define     HALCON_C_LAST_UPDATE      "22.05.2012"
...
LIntExport void   Mcopy_tuple(Htuple const* input, Htuple *output,
                              char const* file, int line);
LIntExport void   Mattach_tuple(Htuple *restrict src, Htuple *restrict dest,
                                char const* file, int line);
...
LIntExport void   F_create_tuple_type(Htuple*restrict htuple, Hlong len,
                                      INT type);
LIntExport void   F_create_tuple(Htuple*restrict htuple, Hlong l);
LIntExport void   F_copy_tuple(Htuple const*restrict in, Htuple*restrict out);
LIntExport void   F_attach_tuple(Htuple *restrict src, Htuple *restrict dest);
LIntExport void   F_resize_tuple(Htuple*restrict htuple, Hlong LEN);
LIntExport void   F_destroy_tuple(Htuple*restrict htuple);
LIntExport void   F_set_i(Htuple*restrict t, Hlong value, Hlong idx);
LIntExport void   F_set_d(Htuple*restrict t, double value, Hlong idx);
LIntExport void   F_set_s(Htuple*restrict t,char const*restrict val,Hlong idx);
LIntExport void   F_init_i(Htuple*restrict t, Hlong value, Hlong idx);
LIntExport void   F_init_d(Htuple*restrict t, double value, Hlong idx);
LIntExport void   F_init_s(Htuple*restrict t, char const*restrict value, 
                           Hlong idx);
LIntExport void   F_init_s_len(Htuple*restrict t, Hlong len, Hlong idx);
LIntExport Hlong  F_get_i(Htuple const*restrict t, Hlong idx);
LIntExport double F_get_d(Htuple const*restrict t, Hlong idx);
LIntExport char const *F_get_s(Htuple const*restrict t, Hlong idx);

/* functions combining (re)creation and one value setting */
LIntExport void   F_create_tuple_i(Htuple*restrict t, Hlong val);
LIntExport void   F_create_tuple_d(Htuple*restrict t, double val);
LIntExport void   F_create_tuple_s(Htuple*restrict t, char* val);
LIntExport void   F_reuse_tuple_i(Htuple*restrict t, Hlong val);
LIntExport void   F_reuse_tuple_d(Htuple*restrict t, double val);
LIntExport void   F_reuse_tuple_s(Htuple*restrict t, char const*restrict val);
...
LIntExport void   replace_elements(Htuple* htuple, 
