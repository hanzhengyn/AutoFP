 ...
 *
 * (c) 2007-2012 by MVTec Software GmbH
 *                  www.mvtec.com
 * 
 *****************************************************************************
 *
...
public:
  ...
  virtual void SetObjectModel3dAttribMod(const Halcon::HTuple &Name, const Halcon::HTuple &Type, const Halcon::HTuple &Data) const;
  // Set attributes of a 3D object model.
  virtual void SetObjectModel3dAttribMod(const char *Name, const char *Type, double Data) const;
  // Set attributes of a 3D object model.
  virtual HObjectModel3D SetObjectModel3dAttrib(const Halcon::HTuple &Name, const Halcon::HTuple &Type, const Halcon::HTuple &Data) const;
  // Set attributes of a 3D object model.
  virtual HObjectModel3D SetObjectModel3dAttrib(const char *Name, const char *Type, double Data) const;
  ...
  // Create a 3D object model that representa a sphere.
  ...
  // Calculate the smallest sphere around the points of a 3D object model.
  virtual double SmallestSphereObjectModel3d(double *Radius) const;
  ...
  // Apply a rigid 3D transformation to 3D object models.
  virtual HTuple RigidTransObjectModel3d(double Pose) const;
