...
#define H_SYSTEM_PROC_NUMBER 1926
#endif
...
LIntExport Herror get_error_text(const Halcon::HTuple &ErrorNumber, Halcon::HTuple *ErrorText);
LIntExport Herror get_error_text(const Halcon::HTuple &ErrorNumber, char *ErrorText);
LIntExport Herror get_error_text(Hlong ErrorNumber, Halcon::HTuple *ErrorText);
...
LIntExport Herror binocular_distance_mg(const Halcon::Hobject &Image1, const Halcon::Hobject &Image2, Halcon::Hobject *Distance, Halcon::Hobject *Score, const Halcon::HTuple &CamParamRect1, const Halcon::HTuple &CamParamRect2, const Halcon::HTuple &RelPoseRect, const Halcon::HTuple &GrayConstancy, const Halcon::HTuple &GradientConstancy, const Halcon::HTuple &Smoothness, const Halcon::HTuple &InitialGuess, const Halcon::HTuple &CalculateScore, const Halcon::HTuple &MGParamName, const Halcon::HTuple &MGParamValue);
LIntExport Herror binocular_disparity_mg(const Halcon::Hobject &Image1, const Halcon::Hobject &Image2, Halcon::Hobject *Disparity, Halcon::Hobject *Score, const Halcon::HTuple &GrayConstancy, const Halcon::HTuple &GradientConstancy, const Halcon::HTuple &Smoothness, const Halcon::HTuple &InitialGuess, const Halcon::HTuple &CalculateScore, const Halcon::HTuple &MGParamName, const Halcon::HTuple &MGParamValue);
...
LIntExport Herror binocular_distance(const Halcon::Hobject &Image1, const Halcon::Hobject &Image2, Halcon::Hobject *Distance, Halcon::Hobject *Score, const Halcon::HTuple &CamParamRect1, const Halcon::HTuple &CamParamRect2, const Halcon::HTuple &RelPoseRect, const Halcon::HTuple &Method, const Halcon::HTuple &MaskWidth, const Halcon::HTuple &MaskHeight, const Halcon::HTuple &TextureThresh, const Halcon::HTuple &MinDisparity, const Halcon::HTuple &MaxDisparity, const Halcon::HTuple &NumLevels, const Halcon::HTuple &ScoreThresh, const Halcon::HTuple &Filter, const Halcon::HTuple &SubDistance);
LIntExport Herror binocular_disparity(const Halcon::Hobject &Image1, const Halcon::Hobject &Image2, Halcon::Hobject *Disparity, Halcon::Hobject *Score, const Halcon::HTuple &Method, const Halcon::HTuple &MaskWidth, const Halcon::HTuple &MaskHeight, const Halcon::HTuple &TextureThresh, const Halcon::HTuple &MinDisparity, const Halcon::HTuple &MaxDisparity, const Halcon::HTuple &NumLevels, const Halcon::HTuple &ScoreThresh, const Halcon::HTuple &Filter, const Halcon::HTuple &SubDisparity);
LIntExport Herror binocular_disparity(const Halcon::Hobject &Image1, const Halcon::Hobject &Image2,Halcon::Hobject *Disparity,Halcon::Hobject *Score, const char *Method, Hlong MaskWidth, Hlong MaskHeight, double TextureThresh, Hlong MinDisparity, Hlong MaxDisparity, Hlong NumLevels, double ScoreThresh, const char *Filter, const char *SubDisparity);
...
LIntExport Herror get_text_result(const Halcon::HTuple &TextResultID, const Halcon::HTuple &ResultName, Halcon::HTuple *Value);
LIntExport Herror get_text_result(const Halcon::HTuple &TextResultID, const Halcon::HTuple &ResultName, Hlong *Value);
...
LIntExport Herror get_text_model_param(const Halcon::HTuple &TextModel, const Halcon::HTuple &Param, Halcon::HTuple *Value);
LIntExport Herror get_text_model_param(const Halcon::HTuple &TextModel, const Halcon::HTuple &Param, Hlong *Value);
LIntExport Herror get_text_model_param(Hlong TextModel, const char *Param, Halcon::HTuple *Value);
LIntExport Herror get_text_model_param(Hlong TextModel, const char *Param, Hlong *Value);
LIntExport Herror set_text_model_param(const Halcon::HTuple &TextModel, const Halcon::HTuple &Param, const Halcon::HTuple &Value);
...
LIntExport Herror transform_metrology_object(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Phi, const Halcon::HTuple &Mode);
...
LIntExport Herror copy_metrology_model(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, Halcon::HTuple *CopiedMetrologyHandle);
LIntExport Herror copy_metrology_model(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, Hlong *CopiedMetrologyHandle);
LIntExport Herror copy_metrology_object(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, Halcon::HTuple *CopiedIndices);
LIntExport Herror copy_metrology_object(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, Hlong *CopiedIndices);
LIntExport Herror get_metrology_object_num_instances(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, Halcon::HTuple *NumInstances);
LIntExport Herror get_metrology_object_num_instances(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, double *NumInstances);
LIntExport Herror get_metrology_object_num_instances(Hlong MetrologyHandle, Hlong Indices, Halcon::HTuple *NumInstances);
LIntExport Herror get_metrology_object_num_instances(Hlong MetrologyHandle, Hlong Indices, double *NumInstances);
LIntExport Herror get_metrology_object_result(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &Instance, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Parameter);
LIntExport Herror get_metrology_object_result(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &Instance, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, double *Parameter);
LIntExport Herror get_metrology_object_measures(Halcon::Hobject *Contour, const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &Transition, Halcon::HTuple *Row, Halcon::HTuple *Column);
...
LIntExport Herror reset_metrology_object_fuzzy_param(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices);
LIntExport Herror reset_metrology_object_param(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices);
LIntExport Herror get_metrology_object_fuzzy_param(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_metrology_object_fuzzy_param(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &GenParamName, double *GenParamValue);
LIntExport Herror get_metrology_object_param(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_metrology_object_param(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &GenParamName, char *GenParamValue);
LIntExport Herror set_metrology_object_fuzzy_param(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror set_metrology_object_param(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror clear_metrology_object(const Halcon::HTuple &MetrologyHandle, const Halcon::HTuple &Indices);
...
LIntExport Herror find_shape_model_3d(const Halcon::Hobject &Image, Hlong ShapeModel3DID, double MinScore, double Greediness, Hlong NumLevels, const char *GenParamNames, Hlong GenParamValues, Halcon::HTuple *Pose, Halcon::HTuple *CovPose, Halcon::HTuple *Score);
...
LIntExport Herror set_object_model_3d_attrib_mod(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &Name, const Halcon::HTuple &Type, const Halcon::HTuple &Data);
LIntExport Herror set_object_model_3d_attrib_mod(Hlong ObjectModel3D, const char *Name, const char *Type, double Data);
LIntExport Herror set_object_model_3d_attrib(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &Name, const Halcon::HTuple &Type, const Halcon::HTuple &Data, Halcon::HTuple *ObjectModel3DOut);
LIntExport Herror set_object_model_3d_attrib(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &Name, const Halcon::HTuple &Type, const Halcon::HTuple &Data, Hlong *ObjectModel3DOut);
LIntExport Herror set_object_model_3d_attrib(Hlong ObjectModel3D, const char *Name, const char *Type, double Data, Halcon::HTuple *ObjectModel3DOut);
LIntExport Herror set_object_model_3d_attrib(Hlong ObjectModel3D, const char *Name, const char *Type, double Data, Hlong *ObjectModel3DOut);
...
LIntExport Herror smallest_sphere_object_model_3d(const Halcon::HTuple &ObjectModel3D, double *CenterPoint, double *Radius);
LIntExport Herror smallest_sphere_object_model_3d(Hlong ObjectModel3D, Halcon::HTuple *CenterPoint, Halcon::HTuple *Radius);
LIntExport Herror smallest_sphere_object_model_3d(Hlong ObjectModel3D, double *CenterPoint, double *Radius);
...
LIntExport Herror rigid_trans_object_model_3d(Hlong ObjectModel3D, double Pose, Halcon::HTuple *ObjectModel3DRigidTrans);
LIntExport Herror rigid_trans_object_model_3d(Hlong ObjectModel3D, double Pose, Hlong *ObjectModel3DRigidTrans);
...
LIntExport Herror get_operator_name(const Halcon::HTuple &Pattern, Halcon::HTuple *ProcNames);
LIntExport Herror get_operator_name(const char *Pattern, Halcon::HTuple *ProcNames);
LIntExport Herror get_param_types(const Halcon::HTuple &ProcName, Halcon::HTuple *InpCtrlParType, Halcon::HTuple *OutpCtrlParType);
LIntExport Herror get_param_types(const char *ProcName, Halcon::HTuple *InpCtrlParType, Halcon::HTuple *OutpCtrlParType);
LIntExport Herror get_param_num(const Halcon::HTuple &ProcName, Halcon::HTuple *CName, Halcon::HTuple *InpObjPar, Halcon::HTuple *OutpObjPar, Halcon::HTuple *InpCtrlPar, Halcon::HTuple *OutpCtrlPar, Halcon::HTuple *Type);
LIntExport Herror get_param_num(const Halcon::HTuple &ProcName, char *CName, Hlong *InpObjPar, Hlong *OutpObjPar, Hlong *InpCtrlPar, Hlong *OutpCtrlPar, char *Type);
LIntExport Herror get_param_num(const char *ProcName, Halcon::HTuple *CName, Halcon::HTuple *InpObjPar, Halcon::HTuple *OutpObjPar, Halcon::HTuple *InpCtrlPar, Halcon::HTuple *OutpCtrlPar, Halcon::HTuple *Type);
...
LIntExport Herror get_param_names(const Halcon::HTuple &ProcName, Halcon::HTuple *InpObjPar, Halcon::HTuple *OutpObjPar, Halcon::HTuple *InpCtrlPar, Halcon::HTuple *OutpCtrlPar);
LIntExport Herror get_param_names(const char *ProcName, Halcon::HTuple *InpObjPar, Halcon::HTuple *OutpObjPar, Halcon::HTuple *InpCtrlPar, Halcon::HTuple *OutpCtrlPar);
LIntExport Herror get_operator_info(const Halcon::HTuple &ProcName, const Halcon::HTuple &Slot, Halcon::HTuple *Information);
LIntExport Herror get_operator_info(const Halcon::HTuple &ProcName, const Halcon::HTuple &Slot, char *Information);
LIntExport Herror get_operator_info(const char *ProcName, const char *Slot, Halcon::HTuple *Information);
LIntExport Herror get_operator_info(const char *ProcName, const char *Slot, char *Information);
LIntExport Herror get_param_info(const Halcon::HTuple &ProcName, const Halcon::HTuple &ParamName, const Halcon::HTuple &Slot, Halcon::HTuple *Information);
LIntExport Herror get_param_info(const Halcon::HTuple &ProcName, const Halcon::HTuple &ParamName, const Halcon::HTuple &Slot, char *Information);
LIntExport Herror get_param_info(const char *ProcName, const char *ParamName, const char *Slot, Halcon::HTuple *Information);
LIntExport Herror get_param_info(const char *ProcName, const char *ParamName, const char *Slot, char *Information);
LIntExport Herror search_operator(const Halcon::HTuple &Keyword, Halcon::HTuple *ProcNames);
LIntExport Herror search_operator(const char *Keyword, Halcon::HTuple *ProcNames);
LIntExport Herror get_keywords(const Halcon::HTuple &ProcName, Halcon::HTuple *Keywords);
LIntExport Herror get_keywords(const char *ProcName, Halcon::HTuple *Keywords);
...
LIntExport Herror optical_flow_mg(const Halcon::Hobject &Image1, const Halcon::Hobject &Image2, Halcon::Hobject *VectorField, const Halcon::HTuple &Algorithm, const Halcon::HTuple &SmoothingSigma, const Halcon::HTuple &IntegrationSigma, const Halcon::HTuple &FlowSmoothness, const Halcon::HTuple &GradientConstancy, const Halcon::HTuple &MGParamName, const Halcon::HTuple &MGParamValue);
...
LIntExport Herror gen_image_surface_second_order(Halcon::Hobject *ImageSurface, const char *Type, double Alpha, double Beta, double Gamma, double Delta, double Epsilon, double Zeta, double Row, double Col, Hlong Width, Hlong Height);
LIntExport Herror gen_image_surface_first_order(Halcon::Hobject *ImageSurface, const Halcon::HTuple &Type, const Halcon::HTuple &Alpha, const Halcon::HTuple &Beta, const Halcon::HTuple &Gamma, const Halcon::HTuple &Row, const Halcon::HTuple &Col, const Halcon::HTuple &Width, const Halcon::HTuple &Height);
LIntExport Herror gen_image_surface_first_order(Halcon::Hobject *ImageSurface, const char *Type, double Alpha, double Beta, double Gamma, double Row, double Col, Hlong Width, Hlong Height);
...
LIntExport Herror create_caltab(const Halcon::HTuple &Width, const Halcon::HTuple &CalTabDescrFile, const Halcon::HTuple &CalTabFile);
LIntExport Herror create_caltab(double Width, const char *CalTabDescrFile, const char *CalTabFile);
LIntExport Herror gen_caltab(const Halcon::HTuple &XNum, const Halcon::HTuple &YNum, const Halcon::HTuple &MarkDist, const Halcon::HTuple &DiameterRatio, const Halcon::HTuple &CalTabDescrFile, const Halcon::HTuple &CalTabPSFile);
...
LIntExport Herror caltab_points(const Halcon::HTuple &CalTabDescrFile, Halcon::HTuple *X, Halcon::HTuple *Y, Halcon::HTuple *Z);
LIntExport Herror caltab_points(const char *CalTabDescrFile, Halcon::HTuple *X, Halcon::HTuple *Y, Halcon::HTuple *Z);
...
LIntExport Herror sim_caltab(Halcon::Hobject *SimImage, const Halcon::HTuple &CalTabDescrFile, const Halcon::HTuple &CameraParam, const Halcon::HTuple &CaltabPose, const Halcon::HTuple &GrayBackground, const Halcon::HTuple &GrayCaltab, const Halcon::HTuple &GrayMarks, const Halcon::HTuple &ScaleFac);
LIntExport Herror disp_caltab(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &CalTabDescrFile, const Halcon::HTuple &CameraParam, const Halcon::HTuple &CaltabPose, const Halcon::HTuple &ScaleFac);
...
LIntExport Herror find_marks_and_pose(const Halcon::Hobject &Image, const Halcon::Hobject &CalTabRegion, const Halcon::HTuple &CalTabDescrFile, const Halcon::HTuple &StartCamParam, const Halcon::HTuple &StartThresh, const Halcon::HTuple &DeltaThresh, const Halcon::HTuple &MinThresh, const Halcon::HTuple &Alpha, const Halcon::HTuple &MinContLength, const Halcon::HTuple &MaxDiamMarks, Halcon::HTuple *RCoord, Halcon::HTuple *CCoord, Halcon::HTuple *StartPose);
LIntExport Herror find_caltab(const Halcon::Hobject &Image, Halcon::Hobject *Caltab, const Halcon::HTuple &CalTabDescrFile, const Halcon::HTuple &SizeGauss, const Halcon::HTuple &MarkThresh, const Halcon::HTuple &MinDiamMarks);
LIntExport Herror find_caltab(const Halcon::Hobject &Image,Halcon::Hobject *Caltab, const char *CalTabDescrFile, Hlong SizeGauss, Hlong MarkThresh, Hlong MinDiamMarks);
