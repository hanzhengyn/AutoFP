...
typedef double (*restrict pHhom_mat_2d)[3]; /* pointer type variant of Hhom_mat_2d   */
typedef double Hhom_mat_3d[3][4];
typedef double (*restrict pHhom_mat_3d)[4]; /* pointer type variant of Hhom_mat_3d   */
typedef double Hproj_mat_2d[3][3];
typedef double (*restrict pHproj_mat_2d)[3]; /* pointer type variant of Hproj_mat_2d */
typedef double Hproj_mat_3d[4][4];
typedef double (*restrict pHproj_mat_3d)[4]; /* pointer type variant of Hproj_mat_3d */
