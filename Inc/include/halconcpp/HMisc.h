...
public:
  ...
  static void CreateCaltab(double Width, const HString& CalTabDescrFile, const HString& CalTabFile);

  // Generate a calibration plate description file and a corresponding PostScript file. (obsolete)
  static void CreateCaltab(double Width, const char* CalTabDescrFile, const char* CalTabFile);

  // Generate a calibration plate description file and a corresponding PostScript file.
  static void GenCaltab(Hlong XNum, Hlong YNum, double MarkDist, double DiameterRatio, const HString& CalTabDescrFile, const HString& CalTabPSFile);

  // Generate a calibration plate description file and a corresponding PostScript file.
  static void GenCaltab(Hlong XNum, Hlong YNum, double MarkDist, double DiameterRatio, const char* CalTabDescrFile, const char* CalTabPSFile);

  // Read the mark center points from the calibration plate description file.
  static void CaltabPoints(const HString& CalTabDescrFile, HTuple* X, HTuple* Y, HTuple* Z);

  // Read the mark center points from the calibration plate description file.
  static void CaltabPoints(const char* CalTabDescrFile, HTuple* X, HTuple* Y, HTuple* Z);
