...
public:
  ...
  HPose GetRectanglePose(const HTuple& CameraParam, const HTuple& Width, const HTuple& Height, const HString& WeightingMode, double ClippingFactor, HTuple* CovPose, HTuple* Error) const;
