 ...
 *****************************************************************************/
  ...
  void DispCaltab(const HString& CalTabDescrFile, const HTuple& CameraParam, const HPose& CaltabPose, double ScaleFac) const;

  // Project and visualize the 3D model of the calibration plate in the image.
  void DispCaltab(const char* CalTabDescrFile, const HTuple& CameraParam, const HPose& CaltabPose, double ScaleFac) const;
