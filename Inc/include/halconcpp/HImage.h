 ...
 *****************************************************************************/
  ...
  HImage BinocularDistanceMg(const HImage& Image2, HImage* Score, const HTuple& CamParamRect1, const HTuple& CamParamRect2, const HPose& RelPoseRect, double GrayConstancy, double GradientConstancy, double Smoothness, double InitialGuess, const HString& CalculateScore, const HTuple& MGParamName, const HTuple& MGParamValue) const;

  // Compute the distance values for a rectified stereo image pair using multigrid methods.
  HImage BinocularDistanceMg(const HImage& Image2, HImage* Score, const HTuple& CamParamRect1, const HTuple& CamParamRect2, const HPose& RelPoseRect, double GrayConstancy, double GradientConstancy, double Smoothness, double InitialGuess, const HString& CalculateScore, const HString& MGParamName, const HString& MGParamValue) const;

  // Compute the distance values for a rectified stereo image pair using multigrid methods.
  HImage BinocularDistanceMg(const HImage& Image2, HImage* Score, const HTuple& CamParamRect1, const HTuple& CamParamRect2, const HPose& RelPoseRect, double GrayConstancy, double GradientConstancy, double Smoothness, double InitialGuess, const char* CalculateScore, const char* MGParamName, const char* MGParamValue) const;

  // Compute the disparities of a rectified image pair using multigrid methods.
  HImage BinocularDisparityMg(const HImage& Image2, HImage* Score, double GrayConstancy, double GradientConstancy, double Smoothness, double InitialGuess, const HString& CalculateScore, const HTuple& MGParamName, const HTuple& MGParamValue) const;

  // Compute the disparities of a rectified image pair using multigrid methods.
  HImage BinocularDisparityMg(const HImage& Image2, HImage* Score, double GrayConstancy, double GradientConstancy, double Smoothness, double InitialGuess, const HString& CalculateScore, const HString& MGParamName, const HString& MGParamValue) const;

  // Compute the disparities of a rectified image pair using multigrid methods.
  HImage BinocularDisparityMg(const HImage& Image2, HImage* Score, double GrayConstancy, double GradientConstancy, double Smoothness, double InitialGuess, const char* CalculateScore, const char* MGParamName, const char* MGParamValue) const;
  ...
  HImage BinocularDistance(const HImage& Image2, HImage* Score, const HTuple& CamParamRect1, const HTuple& CamParamRect2, const HPose& RelPoseRect, const HString& Method, Hlong MaskWidth, Hlong MaskHeight, const HTuple& TextureThresh, Hlong MinDisparity, Hlong MaxDisparity, Hlong NumLevels, const HTuple& ScoreThresh, const HTuple& Filter, const HTuple& SubDistance) const;

  // Compute the distance values for a rectified stereo image pair using correlation techniques.
  HImage BinocularDistance(const HImage& Image2, HImage* Score, const HTuple& CamParamRect1, const HTuple& CamParamRect2, const HPose& RelPoseRect, const HString& Method, Hlong MaskWidth, Hlong MaskHeight, double TextureThresh, Hlong MinDisparity, Hlong MaxDisparity, Hlong NumLevels, double ScoreThresh, const HString& Filter, const HString& SubDistance) const;

  // Compute the distance values for a rectified stereo image pair using correlation techniques.
  HImage BinocularDistance(const HImage& Image2, HImage* Score, const HTuple& CamParamRect1, const HTuple& CamParamRect2, const HPose& RelPoseRect, const char* Method, Hlong MaskWidth, Hlong MaskHeight, double TextureThresh, Hlong MinDisparity, Hlong MaxDisparity, Hlong NumLevels, double ScoreThresh, const char* Filter, const char* SubDistance) const;

  // Compute the disparities of a rectified image pair using correlation techniques.
  HImage BinocularDisparity(const HImage& Image2, HImage* Score, const HString& Method, Hlong MaskWidth, Hlong MaskHeight, const HTuple& TextureThresh, Hlong MinDisparity, Hlong MaxDisparity, Hlong NumLevels, const HTuple& ScoreThresh, const HTuple& Filter, const HString& SubDisparity) const;

  // Compute the disparities of a rectified image pair using correlation techniques.
  HImage BinocularDisparity(const HImage& Image2, HImage* Score, const HString& Method, Hlong MaskWidth, Hlong MaskHeight, double TextureThresh, Hlong MinDisparity, Hlong MaxDisparity, Hlong NumLevels, double ScoreThresh, const HString& Filter, const HString& SubDisparity) const;

  // Compute the disparities of a rectified image pair using correlation techniques.
  HImage BinocularDisparity(const HImage& Image2, HImage* Score, const char* Method, Hlong MaskWidth, Hlong MaskHeight, double TextureThresh, Hlong MinDisparity, Hlong MaxDisparity, Hlong NumLevels, double ScoreThresh, const char* Filter, const char* SubDisparity) const;
  ...
  // Find the best matches of a 3D shape model in an image.
  HPose FindShapeModel3d(const HShapeModel3D& ShapeModel3DID, double MinScore, double Greediness, Hlong NumLevels, const HString& GenParamNames, Hlong GenParamValues, HTuple* CovPose, HTuple* Score) const;

  // Find the best matches of a 3D shape model in an image.
  HPose FindShapeModel3d(const HShapeModel3D& ShapeModel3DID, double MinScore, double Greediness, Hlong NumLevels, const char* GenParamNames, Hlong GenParamValues, HTuple* CovPose, HTuple* Score) const;
  ...
  HImage OpticalFlowMg(const HImage& Image2, const HString& Algorithm, double SmoothingSigma, double IntegrationSigma, double FlowSmoothness, double GradientConstancy, const HTuple& MGParamName, const HTuple& MGParamValue) const;

  // Compute the optical flow between two images.
  HImage OpticalFlowMg(const HImage& Image2, const HString& Algorithm, double SmoothingSigma, double IntegrationSigma, double FlowSmoothness, double GradientConstancy, const HString& MGParamName, const HString& MGParamValue) const;

  // Compute the optical flow between two images.
  HImage OpticalFlowMg(const HImage& Image2, const char* Algorithm, double SmoothingSigma, double IntegrationSigma, double FlowSmoothness, double GradientConstancy, const char* MGParamName, const char* MGParamValue) const;
  ...
  void GenImageSurfaceSecondOrder(const HString& Type, double Alpha, double Beta, double Gamma, double Delta, double Epsilon, double Zeta, double Row, double Col, Hlong Width, Hlong Height);

  // Create a curved gray surface with second order polynomial.
  void GenImageSurfaceSecondOrder(const char* Type, double Alpha, double Beta, double Gamma, double Delta, double Epsilon, double Zeta, double Row, double Col, Hlong Width, Hlong Height);

  // Create a tilted gray surface with first order polynomial.
  void GenImageSurfaceFirstOrder(const HString& Type, double Alpha, double Beta, double Gamma, double Row, double Col, Hlong Width, Hlong Height);

  // Create a tilted gray surface with first order polynomial.
  void GenImageSurfaceFirstOrder(const char* Type, double Alpha, double Beta, double Gamma, double Row, double Col, Hlong Width, Hlong Height);
  ...
  void SimCaltab(const HString& CalTabDescrFile, const HTuple& CameraParam, const HPose& CaltabPose, Hlong GrayBackground, Hlong GrayCaltab, Hlong GrayMarks, double ScaleFac);

  // Simulate an image with calibration plate.
  void SimCaltab(const char* CalTabDescrFile, const HTuple& CameraParam, const HPose& CaltabPose, Hlong GrayBackground, Hlong GrayCaltab, Hlong GrayMarks, double ScaleFac);

  // Extract the 2D calibration marks from the image and calculate initial values for the external camera parameters.
  HTuple FindMarksAndPose(const HRegion& CalTabRegion, const HString& CalTabDescrFile, const HTuple& StartCamParam, Hlong StartThresh, Hlong DeltaThresh, Hlong MinThresh, double Alpha, double MinContLength, double MaxDiamMarks, HTuple* CCoord, HPose* StartPose) const;

  // Extract the 2D calibration marks from the image and calculate initial values for the external camera parameters.
  HTuple FindMarksAndPose(const HRegion& CalTabRegion, const char* CalTabDescrFile, const HTuple& StartCamParam, Hlong StartThresh, Hlong DeltaThresh, Hlong MinThresh, double Alpha, double MinContLength, double MaxDiamMarks, HTuple* CCoord, HPose* StartPose) const;

  // Segment the standard calibration plate region in the image.
  HRegion FindCaltab(const HString& CalTabDescrFile, const HTuple& SizeGauss, const HTuple& MarkThresh, Hlong MinDiamMarks) const;

  // Segment the standard calibration plate region in the image.
  HRegion FindCaltab(const HString& CalTabDescrFile, Hlong SizeGauss, Hlong MarkThresh, Hlong MinDiamMarks) const;

  // Segment the standard calibration plate region in the image.
  HRegion FindCaltab(const char* CalTabDescrFile, Hlong SizeGauss, Hlong MarkThresh, Hlong MinDiamMarks) const;
