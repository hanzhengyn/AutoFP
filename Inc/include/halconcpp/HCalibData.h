 ...
 *****************************************************************************/
  ...
  HTuple GetCalibDataObservPose(Hlong CameraIdx, Hlong CalibObjIdx, Hlong CalibObjPoseIdx) const;

  // Set observed calibration object poses in a calibration data model.
  void SetCalibDataObservPose(Hlong CameraIdx, Hlong CalibObjIdx, Hlong CalibObjPoseIdx, const HTuple& ObjInCameraPose) const;
