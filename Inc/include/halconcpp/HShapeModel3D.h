 ...
 *****************************************************************************/
  ...
  // Find the best matches of a 3D shape model in an image.
  HPose FindShapeModel3d(const HImage& Image, double MinScore, double Greediness, Hlong NumLevels, const HString& GenParamNames, Hlong GenParamValues, HTuple* CovPose, HTuple* Score) const;

  // Find the best matches of a 3D shape model in an image.
  HPose FindShapeModel3d(const HImage& Image, double MinScore, double Greediness, Hlong NumLevels, const char* GenParamNames, Hlong GenParamValues, HTuple* CovPose, HTuple* Score) const;
