...
LIntExport Herror get_error_text(const HTuple& ErrorNumber, HTuple* ErrorText);
...
LIntExport Herror get_text_result(const HTuple& TextResultID, const HTuple& ResultName, HTuple* Value);

LIntExport Herror find_text(const HObject& Image, const HTuple& TextModel, HTuple* TextResultID);

LIntExport Herror get_text_model_param(const HTuple& TextModel, const HTuple& Param, HTuple* Value);

LIntExport Herror set_text_model_param(const HTuple& TextModel, const HTuple& Param, const HTuple& Value);
...
LIntExport Herror transform_metrology_object(const HTuple& MetrologyHandle, const HTuple& Indices, const HTuple& Row, const HTuple& Column, const HTuple& Phi, const HTuple& Mode);
...
LIntExport Herror copy_metrology_model(const HTuple& MetrologyHandle, const HTuple& Indices, HTuple* CopiedMetrologyHandle);

LIntExport Herror copy_metrology_object(const HTuple& MetrologyHandle, const HTuple& Indices, HTuple* CopiedIndices);

LIntExport Herror get_metrology_object_num_instances(const HTuple& MetrologyHandle, const HTuple& Indices, HTuple* NumInstances);

LIntExport Herror get_metrology_object_result(const HTuple& MetrologyHandle, const HTuple& Indices, const HTuple& Instance, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Parameter);

LIntExport Herror get_metrology_object_measures(HObject* Contour, const HTuple& MetrologyHandle, const HTuple& Indices, const HTuple& Transition, HTuple* Row, HTuple* Column);
...
LIntExport Herror reset_metrology_object_fuzzy_param(const HTuple& MetrologyHandle, const HTuple& Indices);

LIntExport Herror reset_metrology_object_param(const HTuple& MetrologyHandle, const HTuple& Indices);

LIntExport Herror get_metrology_object_fuzzy_param(const HTuple& MetrologyHandle, const HTuple& Indices, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_metrology_object_param(const HTuple& MetrologyHandle, const HTuple& Indices, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror set_metrology_object_fuzzy_param(const HTuple& MetrologyHandle, const HTuple& Indices, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror set_metrology_object_param(const HTuple& MetrologyHandle, const HTuple& Indices, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror clear_metrology_object(const HTuple& MetrologyHandle, const HTuple& Indices);
...
LIntExport Herror set_object_model_3d_attrib_mod(const HTuple& ObjectModel3D, const HTuple& Name, const HTuple& Type, const HTuple& Data);

LIntExport Herror set_object_model_3d_attrib(const HTuple& ObjectModel3D, const HTuple& Name, const HTuple& Type, const HTuple& Data, HTuple* ObjectModel3DOut);
...
LIntExport Herror get_operator_name(const HTuple& Pattern, HTuple* ProcNames);

LIntExport Herror get_param_types(const HTuple& ProcName, HTuple* InpCtrlParType, HTuple* OutpCtrlParType);

LIntExport Herror get_param_num(const HTuple& ProcName, HTuple* CName, HTuple* InpObjPar, HTuple* OutpObjPar, HTuple* InpCtrlPar, HTuple* OutpCtrlPar, HTuple* Type);

LIntExport Herror get_param_names(const HTuple& ProcName, HTuple* InpObjPar, HTuple* OutpObjPar, HTuple* InpCtrlPar, HTuple* OutpCtrlPar);

LIntExport Herror get_operator_info(const HTuple& ProcName, const HTuple& Slot, HTuple* Information);

LIntExport Herror get_param_info(const HTuple& ProcName, const HTuple& ParamName, const HTuple& Slot, HTuple* Information);

LIntExport Herror search_operator(const HTuple& Keyword, HTuple* ProcNames);

LIntExport Herror get_keywords(const HTuple& ProcName, HTuple* Keywords);
...
LIntExport Herror optical_flow_mg(const HObject& Image1, const HObject& Image2, HObject* VectorField, const HTuple& Algorithm, const HTuple& SmoothingSigma, const HTuple& IntegrationSigma, const HTuple& FlowSmoothness, const HTuple& GradientConstancy, const HTuple& MGParamName, const HTuple& MGParamValue);
...
LIntExport Herror gen_image_surface_second_order(HObject* ImageSurface, const HTuple& Type, const HTuple& Alpha, const HTuple& Beta, const HTuple& Gamma, const HTuple& Delta, const HTuple& Epsilon, const HTuple& Zeta, const HTuple& Row, const HTuple& Col, const HTuple& Width, const HTuple& Height);

LIntExport Herror gen_image_surface_first_order(HObject* ImageSurface, const HTuple& Type, const HTuple& Alpha, const HTuple& Beta, const HTuple& Gamma, const HTuple& Row, const HTuple& Col, const HTuple& Width, const HTuple& Height);
...
LIntExport Herror create_caltab(const HTuple& Width, const HTuple& CalTabDescrFile, const HTuple& CalTabFile);

LIntExport Herror gen_caltab(const HTuple& XNum, const HTuple& YNum, const HTuple& MarkDist, const HTuple& DiameterRatio, const HTuple& CalTabDescrFile, const HTuple& CalTabPSFile);

LIntExport Herror caltab_points(const HTuple& CalTabDescrFile, HTuple* X, HTuple* Y, HTuple* Z);
...
LIntExport Herror sim_caltab(HObject* SimImage, const HTuple& CalTabDescrFile, const HTuple& CameraParam, const HTuple& CaltabPose, const HTuple& GrayBackground, const HTuple& GrayCaltab, const HTuple& GrayMarks, const HTuple& ScaleFac);

LIntExport Herror disp_caltab(const HTuple& WindowHandle, const HTuple& CalTabDescrFile, const HTuple& CameraParam, const HTuple& CaltabPose, const HTuple& ScaleFac);
...
LIntExport Herror find_caltab(const HObject& Image, HObject* Caltab, const HTuple& CalTabDescrFile, const HTuple& SizeGauss, const HTuple& MarkThresh, const HTuple& MinDiamMarks);
