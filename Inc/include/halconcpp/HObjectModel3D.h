 ...
 *****************************************************************************/
  ...
  // Refine the pose of a surface model in a 3D scene.
  HPose RefineSurfaceModelPose(const HSurfaceModel& SurfaceModelID, const HPose& InitialPose, double MinScore, const HString& ReturnResultHandle, const HString& GenParamName, const HString& GenParamValue, HTuple* Score, HSurfaceMatchingResult* SurfaceMatchingResultID) const;

  // Refine the pose of a surface model in a 3D scene.
  HPose RefineSurfaceModelPose(const HSurfaceModel& SurfaceModelID, const HPose& InitialPose, double MinScore, const char* ReturnResultHandle, const char* GenParamName, const char* GenParamValue, HTuple* Score, HSurfaceMatchingResult* SurfaceMatchingResultID) const;
  ...
  // Find the best matches of a surface model in a 3D scene.
  HPose FindSurfaceModel(const HSurfaceModel& SurfaceModelID, double RelSamplingDistance, double KeyPointFraction, double MinScore, const HString& ReturnResultHandle, const HString& GenParamName, const HString& GenParamValue, HTuple* Score, HSurfaceMatchingResult* SurfaceMatchingResultID) const;

  // Find the best matches of a surface model in a 3D scene.
  HPose FindSurfaceModel(const HSurfaceModel& SurfaceModelID, double RelSamplingDistance, double KeyPointFraction, double MinScore, const char* ReturnResultHandle, const char* GenParamName, const char* GenParamValue, HTuple* Score, HSurfaceMatchingResult* SurfaceMatchingResultID) const;
  ...
  void SetObjectModel3dAttribMod(const HTuple& Name, const HString& Type, const HTuple& Data) const;

  // Set attributes of a 3D object model.
  void SetObjectModel3dAttribMod(const HString& Name, const HString& Type, double Data) const;

  // Set attributes of a 3D object model.
  void SetObjectModel3dAttribMod(const char* Name, const char* Type, double Data) const;

  // Set attributes of a 3D object model.
  HObjectModel3D SetObjectModel3dAttrib(const HTuple& Name, const HString& Type, const HTuple& Data) const;

  // Set attributes of a 3D object model.
  HObjectModel3D SetObjectModel3dAttrib(const HString& Name, const HString& Type, double Data) const;

  // Set attributes of a 3D object model.
  HObjectModel3D SetObjectModel3dAttrib(const char* Name, const char* Type, double Data) const;
  ...
  // Calculate the smallest sphere around the points of a 3D object model.
  double SmallestSphereObjectModel3d(double* Radius) const;
  ...
  // Render 3D object models to get an image.
  HImage RenderObjectModel3d(const HTuple& CamParam, const HPose& Pose, const HString& GenParamName, const HString& GenParamValue) const;

  // Render 3D object models to get an image.
  HImage RenderObjectModel3d(const HTuple& CamParam, const HPose& Pose, const char* GenParamName, const char* GenParamValue) const;
  ...
  // Display 3D object models.
  void DispObjectModel3d(const HWindow& WindowHandle, const HTuple& CamParam, const HPose& Pose, const HString& GenParamName, const HString& GenParamValue) const;

  // Display 3D object models.
  void DispObjectModel3d(const HWindow& WindowHandle, const HTuple& CamParam, const HPose& Pose, const char* GenParamName, const char* GenParamValue) const;
